...
| Supplied text/images | One necessary model client and extraction function |
| Checks and packaging | Existing evaluation entry point, focused standard-library checks, `zipfile` |

No database, agent framework, provider router, language-support layer, persistent extraction cache, or usage-ledger dependency. Choose and pin one model client when integrating it; do not install alternatives speculatively.
